...
{
    m_detectionConfigWidget = new DetectionConfigWidget(this);
    connect(m_detectionConfigWidget, &DetectionConfigWidget::applyRequested,
            this, &SettingsPage::detectionApplyRequested);
    return m_detectionConfigWidget;
}
algorithm::DetectionConfig SettingsPage::detectionConfig() const
{
    return m_detectionConfigWidget->config();
}

void SettingsPage::setDetectionConfig(const algorithm::DetectionConfig& config)
{
    m_detectionConfigWidget->setConfig(config);
}
...
{
    m_detectionConfigWidget->setFeedback(message);
    appendLog(message);
}
