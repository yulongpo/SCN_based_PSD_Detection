...
struct AlarmRule
{
    ...
    std::int64_t startFrequencyHz = 0;
    std::int64_t endFrequencyHz = 0;
    std::int64_t minBandwidthHz = 0;
    std::int64_t maxBandwidthHz = 0;
...
struct PolicySignal
{
    ...
    algorithm::DetectedSignal stableMeasurement;
    algorithm::DetectedSignal rawMeasurement;
    algorithm::BoundaryState boundaryState = algorithm::BoundaryState::Disabled;
    std::size_t pendingBoundaryCount = 0;
    std::size_t requiredBoundaryCount = 0;
    algorithm::SpectrumBranch measurementBranch = algorithm::SpectrumBranch::Average;
    double associationIou = 0.0;
    double associationCenterDistanceHz = 0.0;
    double associationBandwidthRatio = 1.0;
    std::string boundaryDiagnostic;
    bool hasBoundaryMetadata = false;
    std::int64_t representativeSignalId = 0;
    std::vector<std::int64_t> originalSignalIds;
    std::vector<std::int64_t> whitelistIds;
    std::vector<std::string> whitelistNames;
...
struct AlarmEvent
{
    ...
    double rawStartFrequencyHz = 0.0;
    double rawEndFrequencyHz = 0.0;
    double stableStartFrequencyHz = 0.0;
    double stableEndFrequencyHz = 0.0;
    algorithm::BoundaryState boundaryState = algorithm::BoundaryState::Disabled;
    bool hasBoundaryMetadata = false;
    std::uint32_t pendingBoundaryCount = 0;
    std::uint32_t requiredBoundaryCount = 0;
    algorithm::SpectrumBranch measurementBranch = algorithm::SpectrumBranch::Average;
